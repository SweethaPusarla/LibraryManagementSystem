...
CREATE TABLE tbl_borrower (
	...
	CREATE TABLE tbl_book_copies (
		book_copies_CopiesID INT  AUTO_INCREMENT PRIMARY KEY NOT NULL ,
	...
	CREATE TABLE tbl_book_authors (
		book_authors_AuthorID INT AUTO_INCREMENT PRIMARY KEY NOT NULL ,
...
SELECT copies.book_copies_BranchID AS 'Branch ID', branch.library_branch_BranchName AS 'Branch Name',
	   ...
	   WHERE book.book_Title = book_Title AND branch.library_branch_BranchName =  branchName ;
...
CREATE PROCEDURE db_LibraryManagement.NoLoans()
...
CREATE PROCEDURE db_LibraryManagement.LInformation(IN DueDate date , IN LibraryBranchName varchar(50) )

SELECT Branch.library_branch_BranchName AS 'Branch Name',  Book.book_Title AS 'Book Name',
...
CALL db_LibraryManagement.LInformation(CURDATE(),'Sharpstown');  
